...
const ROOT = 'C:/appliancerepairneary';
...
for (const file of files) {
  ...
  // Replace wrapper div + old iframe (NEARY specific: wrapped in margin div)
  content = content.replace(/<div[^>]*style="margin:2rem 0"[^>]*>\s*<iframe[^>]*hub\.fixlify\.app\/book\/nicks-appliance-repair-b8c8ce[^>]*>[\s\S]*?<\/iframe>\s*<\/div>/g, NEW_IFRAME);
  
  // Replace any remaining bare iframe with fixlify URL (not wrapped in div)
